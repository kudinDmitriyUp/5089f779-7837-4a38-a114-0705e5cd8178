    ...
    >
      ...
      <div id="products" data-section="products">
        <ProductCardTwo
          ...
          description="Handpicked labubu designs curated for serious collectors"
          products={[
            {
              id: "1",
              brand: "Labubu Collective",
              name: "Midnight Dreamer",
              price: "$89.99",
              rating: 5,
              reviewCount: "234",
              imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766154630397-2e9tmo68.jpg",
              imageAlt: "Midnight Dreamer labubu figure"
            },
            {
              id: "2",
              brand: "Labubu Collective",
              ...
              imageAlt: "Celestial Wonder labubu figure"
            },
            {
              id: "3",
              brand: "Labubu Collective",
              ...
              imageAlt: "Emerald Forest labubu figure"
            }
          ]}
      ...
      <div id="about" data-section="about">
        <SplitAbout
          title="About Labubu"
          description="We are passionate about bringing authentic, limited-edition labubu collectibles to enthusiasts worldwide. Each figure is carefully selected to ensure quality and uniqueness."
          tag="Our Story"
          bulletPoints={[
            {
              title: "Authentic Designs",
              description: "Only genuine, officially licensed labubu collectibles in our collection",
              icon: CheckCircle
            },
            {
          ...
          imageSrc="https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766154632964-kdqtn4ap.jpg"
          imageAlt="Labubu collectible display"
          textboxLayout="default"
          useInvertedBackground="noInvert"
          imagePosition="right"
        />
      ...
      <div id="testimonials" data-section="testimonials">
        <TestimonialCardFifteen
          testimonial="The quality and authenticity of these labubu figures are unmatched. I've been collecting for years and this is the most reliable source I've found. Every piece exceeds expectations."
          rating={5}
      ...
      <div id="faq" data-section="faq">
        <FaqBase
          ...
          description="Find answers to common questions about our labubu collectibles"
          tag="Help"
          textboxLayout="default"
          useInvertedBackground="noInvert"
          faqs={[
            {
              id: "1",
              title: "Are all labubus authentic?",
              content: "Yes, we only offer officially licensed labubu collectibles from authorized distributors. Each piece comes with authenticity verification."
            },
            {
              id: "2",
      ...
      <div id="contact" data-section="contact">
        <ContactCenter
          ...
          description="Subscribe to our newsletter for exclusive previews of upcoming labubu designs, special collector events, and member-only discounts."
          tagIcon={Mail}
      ...
      <div id="footer" data-section="footer">
        <FooterSplit
          ...
          columns={[
            {
              ...
              items: [
                ...
                { label: "All Labubus", href: "#products" },
          ...
          contactItems={[
            {
              icon: Mail,
              text: "support@labubu-collective.com"
            },
            {
              icon: MapPin,
